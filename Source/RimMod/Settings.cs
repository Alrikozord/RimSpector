...
namespace RimMod
{
    public class Settings : ModSettings
    {
        ...
        public string _baseUrl = "https://localhost:7246/api/v1/RimSpectorData";
        ...
        {
            base.ExposeData();
            Scribe_Values.Look(ref _debug, "debug", false);
            Scribe_Values.Look(ref _debugDumpFolder, "debugDumpFolder", "C:/temp/payload.json");
            ...
            Scribe_Values.Look(ref _baseUrl, "baseUrl", "https://localhost:7246/api/v1/RimSpectorData");
        }
    }
}
